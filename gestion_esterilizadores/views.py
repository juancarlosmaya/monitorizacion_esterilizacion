...
from gestion_esterilizadores.forms import formulario
import datetime
...
def solicitar_nombre(request):
    ...
    if request.method=="POST":
        ...
        if mi_formulario.is_valid():
           ...
           # return render(request,'gestion_esterilizadores/gracias.html')
    ...
    return render(request,'gestion_esterilizadores/name.html',{'mi_formulario':mi_formulario})
